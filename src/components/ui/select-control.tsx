	...
	return (
		<div className={cn('relative h-9', className)} style={style}>
			<button
				...
				className='group absolute inset-0 flex items-center overflow-hidden rounded-[10px] bg-black/80 outline-none'
						...
						<AnimatePresence>
							{isOpen && position ? (
								<m.div
									...
									className='z-30 overflow-hidden rounded-[10px] border border-white/10 bg-black/80 p-1 backdrop-blur-[6px]'
									style={{
										position: 'fixed',
										left: position.left,
