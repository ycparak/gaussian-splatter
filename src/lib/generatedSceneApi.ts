import type { GeneratedScene, GenerationJob, GenerationJobStatus } from '@/shared/types'

export const FINAL_JOB_STATUSES = new Set<GenerationJobStatus>(['done', 'error'])
...
export async function fetchGeneratedScenes(init?: RequestInit): Promise<GeneratedScene[]> {
...
export async function fetchGenerationJob(id: string, signal: AbortSignal): Promise<GenerationJob> {
